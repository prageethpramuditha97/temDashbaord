...
const beepSound = new Audio("./audio/qr.mp3");

        function onScanSuccess(decodedText, decodedResult) {
            beepSound.play();
            var url = server + "api/get_SR_Details/"
			var obj = {
				"sr_no" : decodedText,
				"type" : "srno",
			}
			...
			$.ajax({
				...
				success: function(resultData) {
					document.getElementById('scan_sr').innerHTML = resultData.username;
					document.getElementById('scan_name').innerHTML = resultData.firstname + " " + resultData.lastname;
					document.getElementById('scan_activation').innerHTML = resultData.subscription;
					document.getElementById('scan_marketplace').innerHTML = resultData.marketplace;
					document.getElementById("scan_profile_pic").src = resultData.profile_image; 
				},
